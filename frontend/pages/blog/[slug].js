                ...
                <div class="mx-auto max-w-4xl">
                    <div class="">
                        ...
                        <div class="flex items-center pt-5 md:pt-10">
                            ...
                            <div class="pl-5">
                                <span class="block font-body text-xl font-bold text-grey-10">Dev Soni</span>
                                <span class="block pt-1 font-body text-xl font-bold text-grey-30">24th Jan
                                    2024</span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="ml-0 text-center md:ml-10 md:w-5/6 md:text-left">
                            ...
                            <div class="flex items-center justify-center pt-5 md:justify-start">
                                <a href={profile.github} target="_blank">
                                    <i class="bx bxl-github text-2xl text-primary hover:text-black"></i>
                                </a>
                                <a href={profile.linkedin} class="pl-4">
                                    <i class="bx bxl-linkedin text-2xl text-primary hover:text-black"></i>
                                </a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="bg-primary">
            <div class="container flex flex-col justify-between py-6 sm:flex-row">
                <p class="text-center font-body text-white md:text-left">
                    © Copyright 2025. All right reserved, Dev Soni.
                </p>
                <div class="flex items-center justify-center pt-5 sm:justify-start sm:pt-0">
                    <a href={profile.github}>
                        <i class="bx bxl-github text-2xl text-white hover:text-black"></i>
                    </a>
                    <a href={profile.linkedin} class="pl-4">
                        <i class="bx bxl-linkedin text-2xl text-white hover:text-black"></i>
                    </a>
                </div>
            </div>
        </div>
